...
import { useClients, useProjects, type ProjectStatus } from "../data";
  ...
  return (
    <div className="studio-page">
      <header className="studio-page-head studio-head-row">
        ...
        <Button asChild variant="outline"><Link to="/studio/clients"><Plus aria-hidden="true" />Nouveau client</Link></Button>
      </header>
